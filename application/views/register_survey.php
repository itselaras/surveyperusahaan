        ...
        <div class="card">
            <div class="card-body">
                ...
                <div style="padding: 30px;">
                    <h4 class="text-left">
                        Nama Perusahaan : <?php echo $this->session->nama_perusahaan;?>
                    </h4>
                    <h4 class="text-muted font-18 m-b-5 text-center">Registrasi</h4>
                    <p class="text-muted text-center">Silahkan masukkan data anda.</p>
                <form name="form" action="<?php echo site_url('survey_controller/register_attempt')?>" id="loginF" method="post">
                  <div class="form-row">
                  ...
                  <input name="id_perusahaan" type="hidden" value="<?php echo $this->session->id_perusahaan;?>">
            ...
            $('document').ready(function(){
                  $('#username').keyup(function(){
                       var username = $(this).val();
                        $.ajax ({
                            url : '<?=base_url()?>index.php/Survey_controller/check_user',
                            method : "POST",
