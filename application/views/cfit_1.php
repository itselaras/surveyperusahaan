...
<div class="wrapper" style="padding-top: 130px;">
    ...
    <?php $find = array("<p>","</p>","<br>");?>
        ...
        <div class="container">
            <div class="row" style="margin-bottom: 0px;">
                ...
                <form name="myForm" id="myForm" method="post" action="<?php echo site_url('welcome/submit_cfit_1')?>">
  ...
  <input type="radio" name="cfit_1" id="inlineRadio6" value="F"> F </br>
                        ...
                        <div class="col-12 text-center" style="margin-top: 20px;">
                            <?if ($page == 12):?>
                                <button type="submit" name="sub2" value="sub2" class="btn btn-primary">Next Subtest</button>
                            <?else:?>
                    ...
                    <div class="card" style="padding: 20px; margin-bottom: 0px;">
                        ...
                        <div class="col-12 text-center" >
                            ...
                            <?php for ($i=0;$i<13;$i++):?>
                                ...
                                <a href="<?php echo site_url('welcome/cfit_1/'.$i);?>" name="next" style="width:50px; height:50px; padding:10px; background-color: #e57373; margin-bottom: 10px; margin-left: 5px;"  class="btn btn-primary"><?php echo $i+1;?></a>
                                <?php else:?>
                                <a href="<?php echo site_url('welcome/cfit_1/'.$i);?>" name="next" style="width:50px; height:50px; padding:10px; background-color: #81d4fa; margin-bottom: 10px; margin-left: 5px;"  class="btn btn-primary"><?php echo $i+1;?></a>
                                <?php endif?>
                            <?php endfor ?>
                            <?php endif?>
...
var x = setInterval(function() {
  ...
  if (distance < 0) {
    clearInterval(x);
    window.location.href = '<?=base_url()?>index.php/Welcome/contoh_cfit_2';
  }
}, 1000);
...
function openHasil()
        {
            if( ! $('input[name="cfit_1"]').is(':checked')) 
            { 
