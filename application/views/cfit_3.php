...
<div class="wrapper" style="padding-top: 130px;">
        ...
        <div class="container">
            <div class="row" style="margin-bottom: 0px;">
                ...
                <form name="myForm" id="myForm" method="post" action="<?php echo site_url('welcome/submit_cfit_3')?>">
  ...
  <input type="radio" name="cfit_3" id="inlineRadio1" value="A"> A </br>
                                        <?php echo str_replace($find,"",$user->soal_jawaban_a);?>
                                    </label>
                                    <label class="radio-inline">
  <input type="radio" name="cfit_3" id="inlineRadio2" value="B"> B </br>
                                        <?php echo str_replace($find,"",$user->soal_jawaban_b);?>
                                    </label>
                                    <label class="radio-inline">
  <input type="radio" name="cfit_3" id="inlineRadio3" value="C"> C </br>
                                        <?php echo str_replace($find,"",$user->soal_jawaban_c);?>
                                    </label>
                                    <label class="radio-inline">
  <input type="radio" name="cfit_3" id="inlineRadio4" value="D"> D </br>
                                        <?php echo str_replace($find,"",$user->soal_jawaban_d);?>
                                    </label>        
                                    <label class="radio-inline">
  <input type="radio" name="cfit_3" id="inlineRadio5" value="E"> E </br>
                                        <?php echo str_replace($find,"",$user->soal_jawaban_e);?>
                                    </label>        
                                    <label class="radio-inline">
  <input type="radio" name="cfit_3" id="inlineRadio6" value="F"> F </br>
                                        <?php echo str_replace($find,"",$user->soal_jawaban_f);?>
                                    </label>
                                </div>
                        </div>
                        ...
                        <div class="col-12 text-center" style="margin-top: 20px;">
                            <?if ($page == 12):?>
                                <button type="submit" name="sub4" value="sub4" class="btn btn-primary">Next Subtest</button>
                            <?else:?>
                    ...
                    <div class="card" style="padding: 20px; margin-bottom: 0px;">
                        ...
                        <div class="col-12 text-center" >
                            ...
                            <?php for ($i=0;$i<13;$i++):?>
                                ...
                                <a href="<?php echo site_url('welcome/cfit_3/'.$i);?>" name="next" style="width:50px; height:50px; padding:10px; background-color: #e57373; margin-bottom: 10px; margin-left: 5px;"  class="btn btn-primary"><?php echo $i+1;?></a>
                                <?php else:?>
                                <a href="<?php echo site_url('welcome/cfit_3/'.$i);?>" name="next" style="width:50px; height:50px; padding:10px; background-color: #81d4fa; margin-bottom: 10px; margin-left: 5px;"  class="btn btn-primary"><?php echo $i+1;?></a>
                                <?php endif?>
                            <?php endfor ?>
                            <?php endif?>
...
var x = setInterval(function() {
  ...
  if (distance < 0) {
    clearInterval(x);
    window.location.href = '<?=base_url()?>index.php/Welcome/contoh_cfit_4';
  }
}, 1000);

function openHasil()
        {
            if( ! $('input[name="cfit_3"]').is(':checked')) 
            { 
